...
public class ConsultarAlumno extends JPanel{
    ...
    public ConsultarAlumno(Connection conexion){
    ...
    public void componentes(Connection conexion){
        ...
        JLabel etiquetaTitulo = new JLabel("Consultar Alumno");
        ...
        comboTipoConsulta.setModel(new DefaultComboBoxModel<>(new String[] { "SELECCIONA","ID ALUMNO","NOMBRE",
        ...
        JTable tablaAlumnos = new JTable(AlumnoDAO.modelo);
        config.gridx = 0;
        config.gridwidth = 7;
        config.gridheight = 2;
        config.gridy = 2;
