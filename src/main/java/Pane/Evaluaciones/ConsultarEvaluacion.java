...
import Evaluaciones.EvaluacionesDAO;
...
public class ConsultarEvaluacion extends JPanel{
    ...
    public ConsultarEvaluacion(Connection conexion){
    ...
    public void componentes(Connection conexion){
        ...
        JLabel etiquetaTitulo = new JLabel("Consultar Evaluaciones");
        ...
        comboTipoConsulta.setModel(new DefaultComboBoxModel<>(new String[] { "SELECCIONA","ID EVALUACION","EVALUACION",
                "CALIFICACION","ESTADO","CICLO","ID MATERIA","ID ALUMNO"}));
        config.gridx = 2;
        config.gridwidth = 1;
        config.gridy = 1;
        ...
        JTable tablaAlumnos = new JTable(EvaluacionesDAO.modelo);
        config.gridx = 0;
        config.gridwidth = 7;
        config.gridheight = 2;
        config.gridy = 2;
        ...
        aplicarBoton.addActionListener(e -> {
            try {
                consultarEvaluaciones(conexion);
    ...
    private void consultarEvaluaciones(Connection conexion) throws SQLException {
