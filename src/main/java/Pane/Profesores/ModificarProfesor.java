...
public class ModificarProfesor extends JPanel{
    ...
    public ModificarProfesor(Connection conexion){
    ...
    private void cargarComponentes(){
        ...
        JLabel etiquetaTitulo = new JLabel("Ingresa id del Profesor");
        ...
        verificar.addActionListener(v->{
            try {
                this.profesor = ModificarPorID(conexion);
                etiquetaNombreActual.setText(this.profesor.getNombre());
                etiquetaPrimerApellidoActual.setText(this.profesor.getPrimerApellido());
                etiquetaSegundoApellidoActual.setText(this.profesor.getSegundoApellido());
                etiquetaCurpActual.setText(this.profesor.getCURP());
                etiquetaGeneroActual.setText(this.profesor.getGenero());
                etiquetaIDGrupoActual.setText(String.valueOf(this.profesor.getIdGrupo()));
        ...
        actualizar.addActionListener(v->{
            ...
            try {
                service.update(conexion,nombreActualizado,primerApellidoActualizado,segundoApellidoActualizado,
                        curpActualizado,generoActualizado,idGrupoActualizado,this.profesor);
            } catch (SQLException throwables) {
                throwables.printStackTrace();
            }
        });
        ...
        eliminar.addActionListener(v->{
            try{
                ProfesoresService service = new ProfesoresService();
                service.delete(conexion,this.profesor);
            }catch (SQLException throwables){
                throwables.printStackTrace();
            }
        });
